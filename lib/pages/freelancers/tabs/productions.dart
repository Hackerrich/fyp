        ...
        body: SingleChildScrollView(
          child: Obx(() => Column(
                children: productionController.productionList
                    .map((Production production) => ProductionCard(production))
                    .toList(),
              )),
        ));
  }

  Widget ProductionCard(Production production) {
    return Container(
        height: 450,
        width: 250,
...
//                     .map((Categories category) => ProductionCard(category))
//                     .toList(),
//               )),
//         ));
//   }

//   Widget ProductionCard(Categories category) {
//     return Container(
//         height: 450,
//         width: 250,
//         color: Color.fromARGB(255, 221, 187, 187),
